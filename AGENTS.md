...
- `config/env.example/`: Grouped environment variable templates for local setup.
...
- Never commit secrets or local runtime data (`config/env/`, `config/users.json`, `data/chat.db`).
